...
const add_keyword_dto_1 = require("./dto/add-keyword.dto");
let AdminNewsController = class AdminNewsController {
    constructor(newsIngestionService, fileParsingService, sentimentService, keywordManager, prisma) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [add_keyword_dto_1.AddKeywordDto]),
    __metadata("design:returntype", Promise)
], AdminNewsController.prototype, "addKeyword", null);
__decorate([
