...
export class ImpersonationService {
    ...
    private readonly IMPERSONATION_DURATION_HOURS = parseInt(process.env.IMPERSONATION_DURATION_HOURS || '4');
     ...
     */
    async stopImpersonation(impersonationToken: string, reason: string = 'EXPLICIT_STOP'): Promise<void> {
     ...
     */
    async validateImpersonation(impersonationToken: string): Promise<ImpersonationSession & { admin: any; targetUser: any } | null> {
