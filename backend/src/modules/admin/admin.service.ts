...
export class AdminService {
     ...
     */
    async createSubscription(userId: number, dto: CreateSubscriptionDto, adminId: number) {
        // Create subscription
     ...
     * Update subscription
     */
    async updateSubscription(userId: number, dto: Partial<CreateSubscriptionDto>) {
     ...
     */
    async listUsers(filters?: { role?: string; isActive?: boolean; isTrial?: boolean }) {
